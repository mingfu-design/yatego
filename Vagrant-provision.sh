...
ln -s /vagrant/cmd/callfow-static/callfow-static /opt/yate/share/yate/scripts/yatego-callfow-static
...
printf "\n^921$=external/nodata/yatego-callfow-static" >> /opt/yate/etc/yate/regexroute.conf
